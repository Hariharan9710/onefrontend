...
const Sidebar: React.FC = () => {
  ...
  if (user.role === 'EMPLOYEE') {
    menuItems = [
      { text: 'Dashboard', icon: <Dashboard />, path: '/emp/dashboard' },
      { text: 'Projects', icon: <Work />, path: '/emp/projects' },
      { text: 'Attendance', icon: <AccessTime />, path: '/emp/attendance' },
      { text: 'Leaves', icon: <EventNote />, path: '/emp/leaves' },
    ];
  } else if (user.role === 'HR') {
    menuItems = [
      { text: 'Dashboard', icon: <Dashboard />, path: '/admin-panel/dashboard' },
      { text: 'Employees', icon: <People />, path: '/admin-panel/employees' },
      { text: 'Payroll', icon: <AttachMoney />, path: '/admin-panel/payroll' },
      { text: 'Attendance', icon: <AccessTime />, path: '/admin-panel/attendance' },
    ...
    menuItems = [
      { text: 'Dashboard', icon: <Dashboard />, path: '/admin-panel/dashboard' },
      { text: 'Employees', icon: <People />, path: '/admin-panel/employees' },
      { text: 'Departments', icon: <Business />, path: '/admin-panel/departments' },
      { text: 'Payroll', icon: <AttachMoney />, path: '/admin-panel/payroll' },
      { text: 'Projects', icon: <Work />, path: '/admin-panel/projects' },
      { text: 'Attendance', icon: <AccessTime />, path: '/admin-panel/attendance' },
      { text: 'Leaves', icon: <EventNote />, path: '/admin-panel/leaves' },
      { text: 'Meetings', icon: <MeetingRoom />, path: '/admin-panel/meetings' },
      { text: 'Manage Requests', icon: <RequestPage />, path: '/admin-panel/requests' },
