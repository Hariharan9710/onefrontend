  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [
        ...
        adminApi.get('/admin/employees').catch(_err => ({ data: [] })),
        adminApi.get('/departments').catch(_err => ({ data: [] })),
        adminApi.get('/requests').catch(_err => ({ data: [] })),
        adminApi.get('/payroll').catch(_err => ({ data: [] })),
        adminApi.get('/meetings').catch(_err => ({ data: [] })),
        adminApi.get('/leaves').catch(_err => ({ data: [] }))
      ]);
